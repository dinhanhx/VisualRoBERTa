...
from transformers.tokenization_utils import AddedToken, PreTrainedTokenizer  # type: ignore


SPIECE_UNDERLINE = "▁"   # <- THIS IS U 2581 CHAR, NOT YOUR NORMAL UNDERSCORE
...
class BunTokenizer(PreTrainedTokenizer):
    """
    Copied from BARTPhoTokenizer with little tweaks for Next Sentence Prediction
    ...
    max_model_input_sizes = PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES  # type: ignore
    ...
    def __setstate__(self, d):
        ...
        self.sp_model = spm.SentencePieceProcessor(**self.sp_model_kwargs)
        self.sp_model.LoadFromSerializedProto(self.sp_model_proto)  # type: ignore
    ...
    def build_inputs_with_special_tokens(
        ...
        adding special tokens. A Bun sequence has the following format:
    ...
    def _tokenize(self, text: str) -> List[str]:
        return self.sp_model.encode(text, out_type=str)  # type: ignore
    ...
    def save_vocabulary(self, save_directory: str, filename_prefix: Optional[str] = None) -> Tuple[str]:
        ...
        return out_vocab_file, out_monolingual_vocab_file  # type: ignore
